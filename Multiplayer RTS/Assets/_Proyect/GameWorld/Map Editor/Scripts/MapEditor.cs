...
public class MapEditor : OdinEditorWindow
{
    ...
    public void LoadMap()
    {
        ...
        Layout hexLayout = MapUtilities.GetHexLayout(tileSize, mesh, new Vector2(0, 0), editingMap.hexSizeOffSet);
    ...
    public void SaveMap()
    {
        ...
        editingMap.InitMap(hexMaterials, hexWalkableFlags, hexHeights, hexSlopeDatas);
